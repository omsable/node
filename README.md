...
|:------------- |:---- |:-------- |:--------|:----------- |
| path | `string` | `true` | None | Path to the JavaScript file to execute. |
...
[![Edit node on CodeSandbox](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/oms-services/node)
